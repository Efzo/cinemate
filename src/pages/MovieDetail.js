...
useEffect( () =>  {
  async function fetchMovies(){
    const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=9194fd68a853226231848b1bc5a99796`);
  ...
  return (  
    <main>
        ...
        <section  className="flex justify-around flex-wrap py-5">
            ...
            <div className="mx-w-2xl text-gray-700 text-lg dark:text-white">
              ...
              {movie.genres ? <p  className="my-7 flex flex-wrap gap-2">        
                ...
                <div class="flex items-center">
                    ...
                    <p class="ml-2 text-gray-900 dark:text-white">{movie.vote_average}</p>
                    <span class="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
                    <span class=" text-gray-900 hover:no-underline dark:text-white">{movie.vote_count} reviews</span>
                </div>
